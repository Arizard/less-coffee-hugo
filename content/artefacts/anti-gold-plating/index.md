...
A quick checklist to help engineers _get to simple_ when designing a product
feature. AI code generation tools are lifting the burden of execution, which
means engineers must be even more careful in deciding _what_ to execute on.
...
- Does it require a lot of time commitment but have comparatively _low
  conviction_?
