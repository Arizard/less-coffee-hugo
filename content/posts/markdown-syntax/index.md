...
For example, the below code snippet renders the image that follows:
...
### Render original image (no resizing)

```markdown
![Original size](<Capture One Catalog5757.jpg> "Nails")
{.portrait original=true}
```
